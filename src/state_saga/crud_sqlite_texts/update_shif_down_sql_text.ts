...
export function real_shift_down_guid_sql_text() {
    return `
...
export function update_shif_down_sql_text() {
    return `

                UPDATE content_posts
                SET
                    order_in_list = ( ${real_shift_down_guid_sql_text()} )
