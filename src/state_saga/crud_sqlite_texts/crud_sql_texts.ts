...
function array_crud_sql_texts_basic_combine(params:any):string {
        ...
        if(operation_data){
            ...
            // alert('=== TEST POINT 101 '+JSON.stringify(operation_data))

                        for (const kk in operation_data) {

                                const vv=operation_data[kk]
                                console.log('=== operation_data el ',kk,vv)
                                replace_str=replace_str + kk +" = '"+vv+"' ,"
                            }

                                // alert('=== TEST POINT 102 '+JSON.stringify(replace_str))
